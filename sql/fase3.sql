...
--
-- Host: mysql.intranet    Database: fase3
-- ------------------------------------------------------
...
--
-- Dumping data for table `fornecedores_contatos`
--

LOCK TABLES `fornecedores_contatos` WRITE;
/*!40000 ALTER TABLE `fornecedores_contatos` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `fornecedores_contatos` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-12-13  9:59:36
